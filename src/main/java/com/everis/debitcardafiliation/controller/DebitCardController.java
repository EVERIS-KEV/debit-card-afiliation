...
public class DebitCardController {
    ...
    public Mono<Object> addAccount(
        @PathVariable("id") String id,
        @RequestBody @Valid AccountAffiliate model,
    ...
    public Mono<Object> setPrincipal(
        @PathVariable("id") String id,
        @RequestBody @Valid AccountAffiliate model,
        BindingResult bindinResult
    ) {
    ...
    public Mono<Object> addMovements(@RequestBody @Valid MovementFrom model, BindingResult bindinResult) {
        ...
        return Mono.just(
            service.addMovement(
                new MovementFrom(model.getNumberDebitCard(), model.getPassword(), model.getAmount(), "")
            )
        );
    }
}

...
public class Webclient {
  ...
  public static final WebClient currentAccount = WebClient
    .builder()
    .baseUrl(Constants.Path.CURRENT_ACCOUNT_PATH)
    .defaultHeader(HttpHeaders.CONTENT_TYPE, MediaType.APPLICATION_JSON_VALUE)
    .build();

  public static final WebClient savingAccount = WebClient
    .builder()
    .baseUrl(Constants.Path.SAVING_ACCOUNT_PATH)
    .defaultHeader(HttpHeaders.CONTENT_TYPE, MediaType.APPLICATION_JSON_VALUE)
    .build();

  public static final WebClient fixedAccount = WebClient
    .builder()

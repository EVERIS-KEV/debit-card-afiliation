...
public enum Constants {
    ...
    public static class Path {
        ...
        public static final String CREDIT_ACCOUNT_PATH = HTTP_CONSTANT
            .concat(GATEWAY)
            .concat(SERVICE_PATH)
            .concat("/credits");
        public static final String CURRENT_ACCOUNT_PATH = HTTP_CONSTANT
            .concat(GATEWAY)
            .concat(SERVICE_PATH)
            .concat("/currentAccount");
        public static final String SAVING_ACCOUNT_PATH = HTTP_CONSTANT
            .concat(GATEWAY)
            .concat(SERVICE_PATH)
            .concat("/savingAccount");
        public static final String FIXED_ACCOUNT_PATH = HTTP_CONSTANT
            .concat(GATEWAY)
            .concat(SERVICE_PATH)
    ...
    public static class Messages {
        ...
        public static final String LIMIT_EXCEED_ACCOUNT_PRINCIPAL =
            "El monto sobre pasa el de la cuenta principal, operaciones realizadas.";

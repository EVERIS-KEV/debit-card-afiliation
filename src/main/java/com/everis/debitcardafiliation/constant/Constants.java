...
public enum Constants
{
    ...
    public static class Path{
        ...
        public static final String CREDIT_ACCOUNT_PATH = HTTP_CONSTANT.concat(GATEWAY).concat(SERVICE_PATH).concat("/credits");
        public static final String CURRENT_ACCOUNT_PATH = HTTP_CONSTANT.concat(GATEWAY).concat(SERVICE_PATH).concat("/currentAccount");
        public static final String SAVING_ACCOUNT_PATH = HTTP_CONSTANT.concat(GATEWAY).concat(SERVICE_PATH).concat("/savingAccount");
